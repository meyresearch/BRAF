"""
This script processes PDB files to extract specific chains and write them to new PDB files.
Loads the original TSV file with PDB information
Checks which PDB files were successfully downloaded
Marks them in the DataFrame
Runs parallel processing to extract chains
"""
...
def get_pdb(id, path='Results/InterProPDBs'):
